...
Public Class GroupeControllerTest
    ...
    'Public ReadOnly Property GetGroupes() As List(Of )
    '    Get
    '        Dim liste As New List(Of Groupe)
    '        liste.Add(New Gwb.Common.Models.Groupe With {.GroupeID = 1, .Code = "code 1", .Libelle = " groupe teste 1", .Adresse = "", .Ville = ""})
    '        liste.Add(New Gwb.Common.Models.Groupe With {.GroupeID = 2, .Code = "code 2", .Libelle = " groupe teste 2", .Adresse = "", .Ville = ""})
    '        Return liste
    '    End Get
