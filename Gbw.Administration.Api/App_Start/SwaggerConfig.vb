...
Public Class SwaggerConfig
    Public Shared Sub Register()
        ...
        'GlobalConfiguration.Configuration.EnableSwagger(Function(c) _
        ...
        GlobalConfiguration.Configuration.EnableSwagger(Sub(c)
                                                            c.SingleApiVersion("v1", "Gbw.Administration")
                                                            ' c.IncludeXmlComments(String.Format("{0}\bin\SwaggerAdministration.XML", System.AppDomain.CurrentDomain.BaseDirectory))
